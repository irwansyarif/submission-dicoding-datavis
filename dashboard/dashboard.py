...
all_df = pd.read_csv("https://raw.githubusercontent.com/irwansyarifh/submission-dicoding-datavis/main/dashboard/geolocation.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://raw.githubusercontent.com/irwansyarifh/submission-dicoding-datavis/main/dashboard/geolocation.csv')
...
with st.sidebar:
    ...
    # Logo Image
    st.image("https://raw.githubusercontent.com/irwansyarifh/submission-dicoding-datavis/main/dashboard/streamlit.png")
...
st.caption('Copyright (C) Irwan Syarif H. 2024')